...
const Services = () => {
    ...
    return (
        <div className="my-[70px]">
           <div>
               <h3 className="text-center text-3xl text-orange-600 font-bold">Services</h3>
               <h3 className="text-center text-5xl font-bold">Our Service Area</h3>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[25px] mt-[20px]">
                  {
